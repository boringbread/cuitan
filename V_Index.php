						...
						<div class="border text-center px-2 pt-4 pb-4 shadow" style="border-top-right-radius: 30px; border-top-left-radius: 30px" >
							<div class="d-flex flex-row align-items-center">
								<div class="rounded-circle" style="overflow: hidden;">
									<img src="img/photo1.jpg" class="" width="50px" alt="" style="width: 60px; clip-path: circle();">
								</div>
						...
						<div class="row py-3">
							<div class="col-1">
								<div class="rounded-circle pl-2">
									<img src="img/photo1.jpg" class="" alt="" style="width: 50px; height: 50px; border-radius: 50%; object-fit: cover; object-position: center right;">
								</div>
							</div>
							<div class="col pl-4">
								<div class=" d-flex flex-row align-items-center">
								...
								<div class="d-flex flex-row justify-content-between pr-3 w-50 mt-3">
									<div>
										...
										xml:space="preserve"><g><path d="M496.5,233.842c-30.841-76.706-114.112-115.06-249.823-115.06h-63.953V45.693c0-4.952-1.809-9.235-5.424-12.85
											...
											C511.63,291.039,506.589,259.344,496.5,233.842z"/></g></svg>
										</div>
										<div>
											<svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
										...
										<div>
											...
											<g><path d="M22.429,21.217c-1.123,0-2.17,0.318-3.064,0.859l-3.291-3.291c0.283-0.693,0.445-1.449,0.445-2.242
												...
												c3.264,0,5.91-2.646,5.91-5.912C28.34,23.861,25.693,21.217,22.429,21.217z"/></g>
											</svg>
										</div>
										<div>
					...
					<div class="border-top">
						<div class="rounded border mt-2">
							<div class="row py-3">
								<div class="col-1">
									<div class="rounded-circle pl-2">
										<img src="img/photo2.jpg" class="" alt="" style="width: 50px; height: 50px; border-radius: 50%; object-fit: cover; object-position: center right;">
									</div>
								</div>
								<div class="col pl-4">
									<div class=" d-flex flex-row align-items-center">
										<div class="font-weight-bold">Dionisius Salvavictori Wanggur</div>
										<div class="font-weight-light ml-1">@DionAlJaber</div>
										<div class="font-weight-light ml-1">&#x2022;</div>
										<div class="font-weight-light ml-1">40 min</div>
									</div>
									<div class="pt-1 pr-3">
										Abis UAS langsung nge chill di Masjid.
									</div>
									<div class="d-flex flex-row justify-content-between pr-3 w-50 mt-3">
										<div>
											<svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
								...
								<div>
									<svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="18px" height="18px" viewBox="0 0 485 485" style="enable-background:new 0 0 485 485;" xml:space="preserve">
										<g>
