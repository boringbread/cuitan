...
Route::put('/profile/edit','ProfileController@updateProfile')->name("profile.update");
Route::post('/profile/{id}/follow','ProfileController@followProfile')->name("profile.follow");
Route::post('/profile/{id}/unfollow','ProfileController@unfollowProfile')->name("profile.unfollow");
